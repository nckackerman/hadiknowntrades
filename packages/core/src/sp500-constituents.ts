...
export const SP500_CONSTITUENTS: SP500Constituent[] = [
  ...
  { symbol: "APP", name: "AppLovin", sector: "Communication Services" },
  ...
  { symbol: "DD", name: "DuPont", sector: "Industrials" },
  ...
  { symbol: "FERG", name: "Ferguson Enterprises", sector: "Industrials" },
  ...
  { symbol: "MSCI", name: "MSCI", sector: "Financials" },
  ...
  { symbol: "RDDT", name: "Reddit", sector: "Communication Services" },
  ...
  { symbol: "VMRK", name: "Vivmark Residential", sector: "Real Estate" },
